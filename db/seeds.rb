...
UserManualEntry.create!(user_manual_heading: heading, content: "My father is a salesman and my mother is an accountant, so I'm pretty screwed up in the head.")
UserManualEntry.create!(user_manual_heading: heading, content: "I prefer seeing a project to the end, or at least a good stopping point, than failing in the middle of it (exception being extraneous circumstances where all parties agree that it's just not going to work... then let's just cut loses).")
UserManualEntry.create!(user_manual_heading: heading, content: "I try to just \"float down the mighty river\" and take life as it comes to be... doesn't always work out.")
...
UserManualEntry.create!(user_manual_heading: heading, content: "Fake people/people act differently while around others.")
UserManualEntry.create!(user_manual_heading: heading, content: "Pointless meetings.")
UserManualEntry.create!(user_manual_heading: heading, content: "People who dislike the Brady/Belichick Patriots. They're good. They're winners. Deal with it. (⌐■_■)")

heading = UserManualHeading.create!(content: "What are your quirks?")
UserManualEntry.create!(user_manual_heading: heading, content: "I have issues parsing a large project when a large document is thrown in front of me. It usually takes about 10-15 minutes before I get out of \"this is insane and impossible\" mode to begin to break stuff down and work through it.")
UserManualEntry.create!(user_manual_heading: heading, content: "I've woken up every day at ~5:30AM-6:00AM every day since about 3rd grade. Sometimes I go back to sleep for another hour if it's the weekend.")
UserManualEntry.create!(user_manual_heading: heading, content: "Language Arts (spelling, writing, grammar, reading) was my worst subject in school.")
UserManualEntry.create!(user_manual_heading: heading, content: "I traditionally start work at 7AM and end at 4PM. I'm fine with not doing that if the job requires more traditional hours, but that's typically the pattern I've set into. Though I do pause to check morning turnip prices at ~8:05AM.")
UserManualEntry.create!(user_manual_heading: heading, content: "I tend to sigh at things. That's just usually me venting at something like a changed requirement, getting it out of my system, and then moving on.")
...
UserManualEntry.create!(user_manual_heading: heading, content: "The ability to take a punch to the face (see previous statement).")
...
UserManualEntry.create!(user_manual_heading: heading, content: "I am blunt and honest to a fault. If something isn't correct or doesn't work, I don't sugarcoat it.")
UserManualEntry.create!(user_manual_heading: heading, content: "Beyond that, I typically follow the UNIX philosophy of \"No news is good news.\"")
UserManualEntry.create!(user_manual_heading: heading, content: "I am not above giving out a positive \"good work\" to someone for completing a rather large or complex task.")

heading = UserManualHeading.create!(content: "How do you like to receive feedback?")
UserManualEntry.create!(user_manual_heading: heading, content: "Straight and to the point. Don't dance around feelings. If I screw up, tell me.")
